...
export default function PlanPill({ stopCount, onTap }: Props) {
  ...
  return (
    <button
      ...
      className="lg:hidden absolute bottom-sp-4 left-sp-3 z-20 w-8 h-8 rounded-full flex items-center justify-center font-bold text-lav text-f-md tabular-nums transition-opacity hover:opacity-90 active:opacity-75"
      style={{
