...
const SEED_HERO: Record<string, ExploreHeroSlide[]> = {
  'k-pop': [{ id: 'KP-207', badge: 'ICONIC VENUE', title: 'Olympic Park KSPO Dome', subtitle: '송파구 올림픽로 424 — BTS, Seventeen, and more have all taken this stage. Even between shows, it’s a pilgrimage stop for fans.', cta_label: 'SEE THE VENUE', cta_href: '/map?poi=KP-207', image_url: null }],
  'k-drama': [{ id: 'KD002-001b', badge: 'GOBLIN PILGRIMAGE', title: 'Jumunjin Breakwater', subtitle: '강원 강릉시 주문진읍 교항리 — where Kim Shin and Eun-tak first met. The red-scarf photo tradition still lives on.', cta_label: 'SEE THE ROUTE', cta_href: '/map?poi=KD002-001b', image_url: null }],
  'k-beauty': [{ id: 'KB-NEW-065', badge: 'SHOPPING HUB', title: 'Olive Young Myeongdong', subtitle: '중구 명동8길 14 — Korea’s biggest K-beauty retailer, right in the middle of Seoul’s busiest shopping street.', cta_label: 'START SHOPPING', cta_href: '/map?poi=KB-NEW-065', image_url: null }],
  'k-culture': [{ id: 'KD016-014', badge: 'ROYAL SEOUL', title: 'Gyeongbokgung Palace', subtitle: '종로구 사직로 161 — Korea’s grandest royal palace, with an hourly changing-of-the-guard ceremony.', cta_label: 'EXPLORE PALACES', cta_href: '/map?poi=KD016-014', image_url: null }],
}

const SEED_SECTIONS: Record<string, Record<string, ExplorePoi[]>> = {
  'k-pop': {
    concerts: [
      { poi_id: 'KP-005', name_ko: '인스파이어 아레나', name_en: 'Inspire Arena', primary_image_url: null, display_region: 'Incheon', quality_score: 0, is_trending: false, coords_lat: 37.46668401261223, coords_lng: 126.3905883002809 },
      { poi_id: 'KP-0823', name_ko: '장충체육관', name_en: 'Jangchung Arena', primary_image_url: null, display_region: 'Jung-gu, Seoul', quality_score: 0, is_trending: false, coords_lat: 37.558178171371, coords_lng: 127.006808757736 },
      { poi_id: 'KP-0824', name_ko: '블루스퀘어', name_en: 'Blue Square', primary_image_url: null, display_region: 'Yongsan-gu, Seoul', quality_score: 0, is_trending: false, coords_lat: 37.5408611480276, coords_lng: 127.002548167462 },
      { poi_id: 'KP-0864', name_ko: '고척스카이돔', name_en: 'Gocheok Sky Dome', primary_image_url: null, display_region: 'Guro-gu, Seoul', quality_score: 0, is_trending: false, coords_lat: 37.49821220764421, coords_lng: 126.8670889679075 },
    ],
    tours: [
      { poi_id: 'KP-014', name_ko: '리움미술관', name_en: 'Leeum Samsung Museum', primary_image_url: null, display_region: 'Yongsan-gu, Seoul', quality_score: 0, is_trending: false, is_featured: true, coords_lat: 37.53833657002706, coords_lng: 126.9991174495516 },
      { poi_id: 'KD024-004', name_ko: 'DDP 동대문디자인플라자', name_en: 'Dongdaemun Design Plaza', primary_image_url: null, display_region: 'Jung-gu, Seoul', quality_score: 0, is_trending: false, coords_lat: 37.5671843130818, coords_lng: 127.009911013917 },
      { poi_id: 'KP-067', name_ko: '경리단길', name_en: 'Gyeongridan-gil', primary_image_url: null, display_region: 'Yongsan-gu, Seoul', quality_score: 0, is_trending: false, coords_lat: 37.5397580614249, coords_lng: 126.991721972247 },
      { poi_id: 'KP-111', name_ko: '일산호수공원', name_en: 'Ilsan Lake Park', primary_image_url: null, display_region: 'Goyang, Gyeonggi', quality_score: 0, is_trending: false, coords_lat: 37.6561360415672, coords_lng: 126.764141543966 },
    ],
    agencies: [
      { poi_id: 'KP-075', name_ko: 'JYP 센터', name_en: 'JYP Center', primary_image_url: null, display_region: 'Gangdong-gu, Seoul', quality_score: 0, is_trending: false, agency: 'JYP', coords_lat: 37.524129269795, coords_lng: 127.129131076272 },
      { poi_id: 'KP-192', name_ko: 'SM엔터테인먼트 사옥', name_en: 'SM Entertainment HQ', primary_image_url: null, display_region: 'Seongdong-gu, Seoul', quality_score: 0, is_trending: false, agency: 'SM', coords_lat: 37.54414907499344, coords_lng: 127.0433501688011 },
      { poi_id: 'KP-199', name_ko: 'YG엔터테인먼트 사옥', name_en: 'YG Entertainment HQ', primary_image_url: null, display_region: 'Mapo-gu, Seoul', quality_score: 0, is_trending: false, agency: 'YG', coords_lat: 37.5502023926174, coords_lng: 126.918287778213 },
      { poi_id: 'KP-159', name_ko: '큐브엔터테인먼트', name_en: 'CUBE Entertainment', primary_image_url: null, display_region: 'Seongdong-gu, Seoul', quality_score: 0, is_trending: false, coords_lat: 37.5456099572053, coords_lng: 127.053456066552 },
    ],
    merchandise: [
      { poi_id: 'KP-0250', name_ko: '더현대 서울', name_en: 'The Hyundai Seoul', primary_image_url: null, display_region: 'Yeongdeungpo-gu, Seoul', quality_score: 0, is_trending: false, coords_lat: 37.52587207102913, coords_lng: 126.9284461241116 },
      { poi_id: 'KP-1090', name_ko: '커먼그라운드', name_en: 'Common Ground', primary_image_url: null, display_region: 'Gwangjin-gu, Seoul', quality_score: 0, is_trending: false, coords_lat: 37.54105555235208, coords_lng: 127.0656686600397 },
      { poi_id: 'KP-0408', name_ko: '케이타운포유 코엑스', name_en: 'Ktown4u COEX', primary_image_url: null, display_region: 'Gangnam-gu, Seoul', quality_score: 0, is_trending: false, coords_lat: 37.50996877837638, coords_lng: 127.0613875508475 },
      { poi_id: 'KP-0409', name_ko: '케이타운포유 인사', name_en: 'Ktown4u Insa', primary_image_url: null, display_region: 'Jongno-gu, Seoul', quality_score: 0, is_trending: false, coords_lat: 37.57446722916056, coords_lng: 126.9835517296716 },
    ],
  },
  'k-drama': {
    tours: [
      { poi_id: 'KD002-001b', name_ko: '주문진방파제', name_en: 'Jumunjin Breakwater', primary_image_url: null, display_region: 'Gangneung, Gangwon', quality_score: 0, is_trending: false, is_featured: true, coords_lat: 37.9036, coords_lng: 128.8286 },
      { poi_id: 'KD002-001', name_ko: '비내섬', name_en: 'Binaeseom Island / Binae Trail', primary_image_url: null, display_region: 'Chungju, Chungbuk', quality_score: 0, is_trending: false, coords_lat: 37.10763245243604, coords_lng: 127.8177258622132 },
      { poi_id: 'KD016-003', name_ko: '문경새재 오픈세트장', name_en: 'Mungyeong Saejae Open Set', primary_image_url: null, display_region: 'Mungyeong, Gyeongsangbuk-do', quality_score: 0, is_trending: false, coords_lat: 36.7713996802656, coords_lng: 128.074072026373 },
      { poi_id: 'KD013-009', name_ko: '남이섬', name_en: 'Namiseom Café Area', primary_image_url: null, display_region: 'Chuncheon, Gangwon', quality_score: 0, is_trending: false, coords_lat: 37.79144074509299, coords_lng: 127.5252101432974 },
    ],
    filming: [
      { poi_id: 'KD003-003', name_ko: '오리올', name_en: 'Oriole Rooftop Bar', primary_image_url: null, display_region: 'Yongsan-gu, Seoul', quality_score: 0, is_trending: false, coords_lat: 37.5316076300166, coords_lng: 126.9920215556666 },
      { poi_id: 'KD003-014', name_ko: '남산공원', name_en: 'Namsan Park', primary_image_url: null, display_region: 'Seoul', quality_score: 0, is_trending: false, coords_lat: 37.5524979951415, coords_lng: 126.989316855952 },
      { poi_id: 'KD016-012', name_ko: '용인대장금테마파크', name_en: 'Yongin Dae Jang Geum Park Set', primary_image_url: null, display_region: 'Yongin, Gyeonggi', quality_score: 0, is_trending: false, coords_lat: 37.1211916935391, coords_lng: 127.337579430944 },
      { poi_id: 'KP-0633', name_ko: 'SBS프리즘타워', name_en: 'SBS Prism Tower', primary_image_url: null, display_region: 'Mapo-gu, Seoul', quality_score: 0, is_trending: false, coords_lat: 37.5797103213346, coords_lng: 126.892781019504 },
      { poi_id: 'KD017-015', name_ko: '청진2리항', name_en: 'Cheongjin 2-ri Breakwater', primary_image_url: null, display_region: 'Pohang, Gyeongbuk', quality_score: 0, is_trending: false, coords_lat: 36.1743210094615, coords_lng: 129.395809146558 },
    ],
    historical: [
    ...
    ostCafes: [
      ...
      { poi_id: 'KD010-009', name_ko: '학림다방', name_en: 'Hakrim Dabang', primary_image_url: null, display_region: 'Jongno-gu, Seoul', quality_score: 0, is_trending: false, coords_lat: 37.58195021892664, coords_lng: 127.0016574451341 },
      { poi_id: 'KD017-010', name_ko: '청하공진시장', name_en: 'Cheongha Gongjin Market Café', primary_image_url: null, display_region: 'Pohang, Gyeongbuk', quality_score: 0, is_trending: false, coords_lat: 36.19705421304869, coords_lng: 129.3397715303084 },
    ],
  },
  'k-beauty': {
    skincare: [
      { poi_id: 'KB-FLAG-SU-003', name_ko: 'Amore Seongsu', name_en: 'Amore Seongsu', primary_image_url: null, display_region: 'Seongdong-gu, Seoul', quality_score: 0, is_trending: false, coords_lat: 37.54435844202786, coords_lng: 127.0591808958532 },
      { poi_id: 'KB-NEW-138', name_ko: '설화수 도산플래그십스토어', name_en: 'Sulwhasoo Dosan Flagship', primary_image_url: null, display_region: 'Gangnam-gu, Seoul', quality_score: 0, is_trending: false, coords_lat: 37.52353049099649, coords_lng: 127.0354907462648 },
      { poi_id: 'KB-NEW-144', name_ko: '논픽션 한남', name_en: 'Nonfiction Hannam', primary_image_url: null, display_region: 'Yongsan-gu, Seoul', quality_score: 0, is_trending: false, coords_lat: 37.53625706385359, coords_lng: 127.0003428273847 },
      { poi_id: 'KB-NEW-152', name_ko: '이솝 성수', name_en: 'Aesop Seongsu', primary_image_url: null, display_region: 'Seongdong-gu, Seoul', quality_score: 0, is_trending: false, coords_lat: 37.5423129121868, coords_lng: 127.056022296655 },
      { poi_id: 'KB-NEW-065', name_ko: '올리브영 명동타운', name_en: 'Olive Young Myeongdong Town', primary_image_url: null, display_region: 'Jung-gu, Seoul', quality_score: 0, is_trending: false, district: 'Myeongdong', coords_lat: 37.56398256073924, coords_lng: 126.9851873129621 },
    ],
    makeup: [
    ...
    spa: [
      ...
      { poi_id: 'KB-DER-MD-005', name_ko: 'Lienjang Clinic Myeongdong', name_en: 'Lienjang Clinic Myeongdong', primary_image_url: null, display_region: 'Jung-gu, Seoul', quality_score: 0, is_trending: false, district: 'Myeongdong', coords_lat: 37.563410116935, coords_lng: 126.982886367076 },
      { poi_id: 'KB-NEW-416', name_ko: '아이디병원', name_en: 'ID Hospital', primary_image_url: null, display_region: 'Gangnam-gu, Seoul', quality_score: 0, is_trending: false, district: 'Gangnam', coords_lat: 37.5177642310409, coords_lng: 127.024157143362 },
      { poi_id: 'KB-DER-MD-003', name_ko: 'Muse Clinic Myeongdong', name_en: 'Muse Clinic Myeongdong', primary_image_url: null, display_region: 'Jung-gu, Seoul', quality_score: 0, is_trending: false, district: 'Myeongdong', coords_lat: 37.5609593565496, coords_lng: 126.982547382568 },
    ],
    salon: [
  ...
  'k-culture': {
    traditional: [
      { poi_id: 'KD016-006', name_ko: '북촌한옥마을', name_en: 'Bukchon Hanok Village', primary_image_url: null, display_region: 'Jongno-gu, Seoul', quality_score: 0, is_trending: false, region: 'Seoul', coords_lat: 37.58176815383344, coords_lng: 126.9848124506409 },
