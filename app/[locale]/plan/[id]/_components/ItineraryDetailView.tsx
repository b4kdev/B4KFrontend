...
export default function ItineraryDetailView({ id }: { id: string }) {
  ...
  if (isError) {
    return (
      <div
        className="fixed top-[50px] lg:top-[56px] left-0 right-0 bottom-14 lg:left-[56px] lg:bottom-0 z-10 flex flex-col items-center justify-center gap-sp-4 bg-bg px-sp-6 text-center"
        role="alert"
      >
  ...
  if (isPrivate) {
    return (
      <div className="fixed top-[50px] lg:top-[56px] left-0 right-0 bottom-14 lg:left-[56px] lg:bottom-0 z-10 flex flex-col items-center justify-center gap-sp-3 bg-bg text-center px-sp-6">
        <Lock size={32} strokeWidth={2} className="text-fg opacity-[0.15]" aria-hidden="true" />
  ...
  if (isNotFound || !itinerary) {
    return (
      <div className="fixed top-[50px] lg:top-[56px] left-0 right-0 bottom-14 lg:left-[56px] lg:bottom-0 z-10 flex flex-col items-center justify-center gap-sp-3 bg-bg text-center px-sp-6">
        <Route size={32} strokeWidth={2} className="text-fg opacity-[0.15]" aria-hidden="true" />
