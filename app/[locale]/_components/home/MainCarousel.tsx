  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col justify-end p-9 md:p-11">
        ...
        <h1 className="text-fg font-display text-f-display-hero tracking-[-0.02em] mb-3 whitespace-pre-line break-words md:break-normal max-w-[520px] md:max-w-[960px] line-clamp-2 md:line-clamp-3">
          {slide.title}
        </h1>
