...
1. Check `B4K-FRD-v2.0.xlsx` for the screen ID requirements
2. `/clear` to start fresh context
3. Build: Mobile.tsx + Desktop.tsx + index.tsx (if architecturally distinct)
4. Wire: SWR hook → `app/api/[route]`
5. i18n: all 7 languages in one pass
6. DoD check: all 6 gates
