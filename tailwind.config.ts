  ...
  theme: {
    extend: {
      colors: {
        ...
        "map-pin":     "var(--map-pin)",
        "map-pin-mid": "var(--map-pin-mid)",
        "map-pin-dim": "var(--map-pin-dim)",
        // Backgrounds
        "bg":         "var(--bg)",
        "bg-2":       "var(--bg-2)",
        "bg-3":       "var(--bg-3)",
      ...
      fontSize: {
        ...
        "f-xl":   "var(--f-xl)",
        "f-2xl":  "var(--f-2xl)",
        "f-display-tile":    "var(--f-display-tile)",
        "f-display-feature": "var(--f-display-feature)",
        "f-display-hero":    "var(--f-display-hero)",
      },
    },
  },
  plugins: [],
